const Sidebar = () => {
  const menuItems = [
    ...
    { name: 'AI Audit', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    { name: 'Services', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { name: 'Voting', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    ...
    <aside className="w-64 glass-panel h-[calc(100vh-6rem)] hidden lg:flex flex-col p-4 animate-[float-slow_8s_ease-in-out_infinite]">
      ...
      <nav className="flex-1 space-y-2">
        {menuItems.map((item, index) => (
          ...
          >
            <svg className={`w-5 h-5 ${index === 0 ? 'text-neon-blue' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
